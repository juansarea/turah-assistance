...
export const PROMPT_CONFIG = {
    ...
    7.  **GUNAKAN FORMAT MARKDOWN:** Gunakan format Markdown untuk membuat output mudah dibaca  seperti Judul utama menggunakan satu tanda pagar (#) dan Informasi detail menggunakan bullet list (-) tanpa cetak tebal atau heading tambahan. JANGAN gunakan mark (*).
