...
export const PROMPT_CONFIG = {
    ...
    3.  **RINCIKAN SETIAP FITUR:** Untuk setiap fitur, pecah menjadi alur proses (user flow) yang jelas dari awal hingga akhir. Deskripsikan dengan detail setiap langkah dalam alur tersebut dengan bahasa indonesia yang mudah dipahami.
    4.  **IDENTIFIKASI AKTOR:** Tentukan siapa saja (misal: User, Admin, Tamu) yang berinteraksi dengan setiap fitur.
    5.  **JANGAN LEWATKAN APAPUN:** Pastikan setiap poin mentah dari pengguna tercakup dalam hasil analisa Anda. Jika ada yang ambigu, berikan asumsi yang masuk akal dan tandai sebagai "Asumsi".
    6.  **GUNAKAN FORMAT MARKDOWN:** Gunakan format Markdown untuk membuat output mudah dibaca  seperti Judul utama menggunakan satu tanda pagar (#) dan Informasi detail menggunakan bullet list (-) tanpa cetak tebal atau heading tambahan. JANGAN gunakan mark (*).
